<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBakar.aspx.cs" Inherits="IcProg.EditBakar" %>
...
<div id="page-heading"><h2>עריכת בקרה</h2></div>
...
<tr>
	...
	<td>
        ...
        <tr>
		  ...
		  <td><asp:TextBox ID="Teormeforat" runat="server" height=" 97px" width=" 378px" CssClass ="form-control" TextMode="MultiLine" dir="rtl"></asp:TextBox></td>
            <th valign="top"  >
                <br />
                :תאור מפורט</th>
		  <td></td>
		...
		<td></td>
           ...
           <td>
                ...
                <th valign="top"></th>
                 ...
                 <tr>
                     <td>
                          <asp:FileUpload runat="server" ID="myUpload" class="btn btn-default btn-file" AllowMultiple="True"/>
		...
		<td class="auto-style3">	
            ...
            <th valign="top" class="auto-style3">
                <br />
                :רמת קושי</th>
 ...
 <th>
	...
	<tr>
            ...
            &nbsp;
            &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button1" runat="server" Text="עדכן נתונים" CssClass="btn btn-default" OnClick="Submitbakar_Click"     />
                </th>
