<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="taskee.aspx.cs" Inherits="IcProg.taskee" %>
...
<div id="page-heading"><h2>הוספת משימות</h2></div>

    <ul class="nav nav-tabs">
         <li role="presentation" class="active"><a >הוספת משימה</a></li>
...
<tr>
	...
	<tr valign="top">
	<td style="background-image: url('back2.jpg')">
    ...
    <tr>
		...
		<td></td>
            ...
            <tr>
            <td><asp:TextBox ID="AhuzLebizua" runat="server" class="form-control" dir="rtl" PlaceHolder="%הכנס מספר אחוזים"></asp:TextBox></td>
           ...
           <td>
               ...
               <asp:DropDownList ID="makorParshanot" runat="server" class="form-control" dir="rtl" DataSourceID="parshanot" DataTextField="drisha_Lefi_parshanot_mishpatit" DataValueField="drisha_Lefi_parshanot_mishpatit">
  ...
  <tr>
	...
	<tr>
		<th> 
            ...
            &nbsp;</th>
		<td valign="top">
            <asp:Button ID="Submit" runat="server" Text="הוסף" class="btn btn-default" OnClick="Submit_Click" />
...
<div class="clear">&nbsp;</div>
    ...
    <asp:SqlDataSource ID="parshanot" runat="server" ConnectionString="<%$ ConnectionStrings:ICConnectionString %>" SelectCommand="SELECT [drisha_Lefi_parshanot_mishpatit] FROM [HazanatDrishaLefiParshanutMishpatit]"></asp:SqlDataSource>
