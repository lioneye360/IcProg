		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="חזרה לדף הוספת רגולציה" class="btn btn-default" OnClick="Button2_Click" BackColor="#3399FF" BorderColor="#660066" ForeColor="White"  />
                    
				
				
				
				    <tr>
                        <td dir="rtl" style="background-color: #FFFFFF; background-image: url('back2.jpg');">
                            <br />
                            <div class="gvclass">
                            <asp:GridView ID="GridView1" dir="rtl" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="Vertical" AllowPaging="True" AllowSorting="True" ForeColor="Black" OnRowCommand="GridView1_RowCommand" CaptionAlign="Right" HorizontalAlign="Right" CssClass="table-responsive" PageSize="5">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MmoedYesum" HeaderText="חודש ליישם" SortExpression="MmoedYesum" />
                                    <asp:BoundField DataField="YmoedYesum" HeaderText="שנה ליישום" SortExpression="YmoedYesum" />
