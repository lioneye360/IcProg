...
<tr>
    ...
    <tr>
		...
		<td>	
		<asp:DropDownList ID="HagdaratMesimot" runat="server" class="form-control" DataSourceID="Task" DataTextField="NameTask" DataValueField="Id" dir="rtl">
             <asp:ListItem value="3" selected="True|False">
      Text
   </asp:ListItem>
		     <asp:ListItem></asp:ListItem>
		</asp:DropDownList>
 ...
 <th colspan="1">
	...
	<tr>
		...
		<td valign="top" class="auto-style10">
            <asp:Button ID="Submitbakar" runat="server" Text="הוסף" CssClass="btn btn-default" OnClick="Submitbakar_Click"    />
...
<td style="background-image: url('back2.jpg')"></td>
</tr>
</table>
...
<div id="footer">
    ...
    <asp:SqlDataSource ID="Task" runat="server" ConnectionString="<%$ ConnectionStrings:ICConnectionString %>" SelectCommand="SELECT TOP 5 [NameTask], [Id] FROM [AddTaskToController]"></asp:SqlDataSource>
    <asp:SqlDataSource ID="TypeBakar" runat="server" ConnectionString="<%$ ConnectionStrings:ICConnectionString %>" SelectCommand="SELECT [NameTypeBakar] FROM [TypeBakar]"></asp:SqlDataSource>
        ...
        <asp:Button class="btn1" runat="server" Text="Button" />
        <asp:Button class="btn2" runat="server" Text="Button" />
