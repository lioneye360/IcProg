...
<div id="page-top">
  ...
  <div class="form-group">
    <input type="text" class="form-control" placeholder="חפש" disabled="disabled">
  </div>
  <button type="submit" class="btn btn-default" disabled="disabled">חפש</button>
</div>
	<%--<div id="top-search">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<asp:Button ID="Button2" runat="server" Text="חזרה להוספת בקרה" CssClass="btn btn-default dropdown-toggle" OnClick="Button2_Click" BackColor="#3399FF" BorderColor="#660066" ForeColor="White"  />
                            ...
                            <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" AllowSorting="True" DataKeyNames="Id" OnRowCommand="GridView1_RowCommand" AllowPaging="True" PageSize="5" >
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ShowHeader="False" HeaderText="עדכון נתונים">
                                        <ItemTemplate>
                                            <asp:Button ID="Button1" runat="server" CausesValidation="false" CommandName="editee" Text="עדכן נתונים" CommandArgument=<%#Eval("Id") %> />
                                        </ItemTemplate>
