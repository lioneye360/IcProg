                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" DataKeyNames="Id" ForeColor="Black" GridLines="Vertical" OnRowCommand="GridView1_SelectedIndexChanged" >
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ShowHeader="False" FooterText="עדכן" HeaderText="עדכון הנתונים">
                                        <ItemTemplate>
                                            <asp:Button ID="Button1" runat="server" CausesValidation="false" CommandName="edite" Text="עדכן" CommandArgument=<%#Eval("Id") %> />
                                        </ItemTemplate>
